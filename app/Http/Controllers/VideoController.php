...
class VideoController extends Controller
{
    ...
    public function search(Request $request){
        ...
        $title='show the research results' . $request->term;
        return view('videos.my-videos',compact('videos','title'));
    }
    ...
    public function mostViewedVideos(){
        ...
        return view('admin.most-Viewed-Videos',compact('mostViewedVideos'))->with('videoNames',json_encode($videoNames,JSON_NUMERIC_CHECK))
