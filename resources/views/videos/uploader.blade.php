    ...
    <div class="card mb-2 col-md-8">
        ...
        @if (auth()->user()->block)
            <div class="alert alert-danger" role="alert">
                Sorry we can not upload this video , you can communicate with the administration to find out why
            </div>
        @else
            ...
            <div class="card-body">
                <form action="{{route('videos.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group file-area">
                        <label for="video">Video Section</label>
                        <input type="file" accept="video/*" onchange="readVideo(this);" class="form-control @error('video') is-invalid @enderror" id="video" name="video">
                        <div class="input-title">Pull the video section to here or Click to choose manually</div>
            ...
            if (input.files && input.files[0]) {
                ...
                $(".video-name").html('\
                    <div class="alert alert-primary">\
                        The video section was chosen successfilly '+input.files[0].name+'\
                    </div>'
                );
            }
        }
